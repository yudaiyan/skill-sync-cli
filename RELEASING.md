...
- `dist/skill-sync-cli-0.1.0.tgz`：可分发的 npm 安装包。
...
```bash
npm view skill-sync-cli version
npx --yes skill-sync-cli@0.1.0 --version
npx --yes skill-sync-cli@0.1.0 --help
```
